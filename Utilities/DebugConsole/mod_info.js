...
Note that errors and warnings from using modinx API through command line will be logged, then picked up and reported by Modnix. Modnix does not make an exception for this mod and the mod itself should not cause errors or warnings.",
   Disables:
