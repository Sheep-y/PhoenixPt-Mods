({
   ...
   Requires: "Zy.cSharp",
   Actions : [{
      // Set the defaults for subsequence properties
      "Action" : "Default",
      // By default, action triggers when the game switches to geoscape or tactical for the first time.
      //"Phase" : "GameMod",
      // Default error handling is "log, continue", which log at error level.  Change "continue" to "stop" to stop on error.
      "OnError" : "warn, continue"
      ...
      "Eval" : 'pla.Abilities = pla.Abilities.Where( e => e.Guid != "0ea4735b-dde8-e904-180e-3e1faef16a56" ) // (Multi-line is ok)
