...
namespace Sheepy.PhoenixPt_SkipIntro {
   ...
   public class Mod {
      ...
      public static void Init () {
         ...
         //Patch( harmony, typeof( PhoenixGame ).GetMethod( "Initialize", Public | Instance ), typeof( Mod ).GetMethod( "Prefix_Init" ) );
         //Patch( harmony, typeof( PhoenixGame ).GetMethod( "BootCrt", NonPublic | Instance ), typeof( Mod ).GetMethod( "Prefix_Boot" ) );
         //Patch( harmony, typeof( VideoPlaybackController ).GetMethod( "Play", Public | Instance ), null, typeof( Mod ).GetMethod( "Postfix_Play" ) );
